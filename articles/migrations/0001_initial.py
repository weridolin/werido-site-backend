# Generated by Django 3.2.3 on 2021-10-02 09:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='名称', max_length=255, null=True, verbose_name='标签名称')),
                ('description', models.TextField(help_text='描述', null=True, verbose_name='标签描述')),
            ],
            options={
                'verbose_name': '文章标签',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='名称', max_length=255, null=True, verbose_name='分类名称')),
                ('description', models.TextField(help_text='描述', null=True, verbose_name='类型描述')),
            ],
            options={
                'verbose_name': '文章类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.IntegerField(default=0, help_text='评论点赞数', verbose_name='评论点赞数')),
                ...
                ('address', models.CharField(default='广东-广州', help_text='留言人地址', max_length=64, verbose_name='留言人地址')),
            ],
            options={
                'verbose_name': '网站流言',
                'verbose_name_plural': '网站流言',
                'db_table': 'siteComments',
            },
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('title', models.CharField(help_text='标题', max_length=255, null=True, verbose_name='标题')),
                ('summary', models.TextField(help_text='概括', null=True, verbose_name='概括')),
                ('content', models.TextField(help_text='正文', null=True, verbose_name='正文')),
                ('likes', models.IntegerField(default=0, help_text='文章点赞数', null=True, verbose_name='文章点赞数')),
                ...
                ('tags', models.ManyToManyField(blank=True, null=True, to='articles.Tags')),
                ('type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='articles.Types')),
            ],
            options={
                'verbose_name': '博客文章',
