# Generated by Django 3.2.3 on 2021-10-05 04:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0002_backgroundmusic_friendslink_homepictures'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replay_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sitecomment_replay_to', to='home.sitecomments')),
            ],
            options={
                'verbose_name': '网站留言',
