# Generated by Django 4.0.4 on 2024-03-20 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(db_index=True, default=thirdApis.models.get_uuid, help_text='会话ID', primary_key=True, serialize=False, verbose_name='会话ID')),
                ('user_id', models.SmallIntegerField(help_text='会话创建者', verbose_name='会话创建者')),
                ('model', models.CharField(help_text='模型名称', max_length=64, verbose_name='模型名称')),
                ('description', models.TextField(help_text='会话描述', null=True, verbose_name='会话描述')),
                ('platform', models.CharField(choices=[('openai', 'openai'), ('ali', 'ali')], help_text='平台名称', max_length=64, verbose_name='平台名称')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('uuid', models.UUIDField(db_index=True, default=thirdApis.models.get_uuid, help_text='消息UUID', primary_key=True, serialize=False, verbose_name='消息UU会话ID')),
                ('conversation_id', models.UUIDField(help_text='所属会话ID', verbose_name='所属会话ID')),
                ('query_content', models.TextField(help_text='消息内容', verbose_name='消息内容')),
                ('query_content_type', models.CharField(default='text', help_text='消息类型', max_length=16, verbose_name='消息类别')),
                ('reply_content_type', models.CharField(default='text', help_text='消息类型', max_length=16, verbose_name='消息类别')),
                ('parent_message_uuid', models.UUIDField(help_text='上一条消息UUID,主要记录会话里面的顺序', null=True, verbose_name='上一条消息ID')),
                ('children_message_uuid', models.UUIDField(help_text='下一条消息UUID,主要记录会话里面的顺序', null=True, verbose_name='下一条消息ID')),
                ('reply_content', models.TextField(help_text='回复内容', null=True, verbose_name='回复内容')),
                ('reply_finish', models.BooleanField(default=False, help_text='是否回复完成', verbose_name='是否回复完成')),
                ('user_id', models.SmallIntegerField(help_text='消息发送者', verbose_name='消息发送者')),
                ('interrupt', models.BooleanField(default=False, help_text='是否半途停止', verbose_name='是否半途停止')),
                ('interrupt_reason', models.CharField(help_text='停止类型', max_length=16, null=True, verbose_name='停止类型')),
                ('websocket_id', models.UUIDField(db_index=True, default=thirdApis.models.get_uuid, help_text='该次对话对应的websocketID', verbose_name='websocketID')),
                ('has_sended', models.BooleanField(default=False, help_text='是否已经发送给客户端', verbose_name='是否已经发送给客户端')),
                ('error', models.BooleanField(default=False, help_text='是否出错', verbose_name='是否出错')),
                ('error_code', models.CharField(help_text='错误代码', max_length=64, null=True, verbose_name='错误代码')),
                ('error_detail', models.CharField(help_text='错误详情', max_length=256, null=True, verbose_name='错误详情')),
            ],
            options={
