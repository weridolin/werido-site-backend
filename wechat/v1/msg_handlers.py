...
CHATGPT_MODE_ENTER_SUCCESS_REPLY = """"""
...
def text_msg_handler(to: str, from_: str, content: str):
    try:
        ...
        if query_type == "chatGPT":
            ...
            update_chatGPT_mode_time_remain(user_id=to) #todo  async?
